...
$(function () {
    ...
    $('.header__nav-item-submenu').hover(function () {
        $('.header__nav-item-submenu-content').slideDown();
    }, function () {
        $('.header__nav-item-submenu-content').slideUp('fast');
    });
    $('.header__nav-item-submenu-content-1-item-drop').hover(function () {
        $('.header__nav-item-submenu-content-1-item-drop-content').slideDown();
    }, function () {
        $('.header__nav-item-submenu-content-1-item-drop-content').slideUp('fast');
    });
    var item = $('.header__nav-item-submenu-content-1-item');
    ...
    var item2 = $('.header__nav-item-submenu-content-1-item-drop-content-item');
